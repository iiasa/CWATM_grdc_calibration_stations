...
grdc_stations = "results/grdc_Merit_1.txt"
...
grdc_Merit = "results/grdc_Merit_2.txt"
...
for stationNo in range(len(grdc)):
    ...
    shapename1 = rootgrdcshape + no + ".shp"
    if os.path.isfile(shapename1):
        s1 = gp.GeoDataFrame.from_file(shapename1)
